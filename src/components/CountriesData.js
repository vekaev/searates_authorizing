export const countriesData = [
  ...
  { name: 'Aland Islands', code: 'AX', dial_code: '358-18' },
  ...
  { name: 'Antarctica', code: 'AQ', dial_code: '' },
  ...
  { name: 'Bonaire, Saint Eustatius and Saba ', code: 'BQ', dial_code: '599' },
  { name: 'Bosnia and Herzegovina', code: 'BA', dial_code: '387' },
  { name: 'Botswana', code: 'BW', dial_code: '267' },
  { name: 'Bouvet Island', code: 'BV', dial_code: '' },
  ...
  { name: 'French Southern Territories', code: 'TF', dial_code: '' },
  ...
  { name: 'Heard Island and McDonald Islands', code: 'HM', dial_code: '' },
